...
translatorMsgTitle = \case
    ...
    Vietnamese -> "Các dịch giả của Aura:"
...
buildFail_12 = \case
    ...
    Vietnamese -> "Thất bại khi dùng 'git pull' để cập nhật."
...
getRealPkgConflicts_2 (bt . pnName -> p) = \case
  ...
  Vietnamese -> "Gói " <> p <> "đã bị bỏ qua! Hãy xem trong tệp `pacman.conf` của bạn."
...
install_4 = \case
    ...
    Vietnamese -> "Quá trình cài đặt bị hủy."
...
reportUnneededPackages_1 = \case
    ...
    Vietnamese -> "Các gói sau đã được cài đặt:"
...
reportPkgsToInstall_3 = \case
    ...
    Vietnamese -> "Các gói AUR phụ thuộc:"
...
reportPkgsToUpgrade_1 = \case
    ...
    Vietnamese -> "Các gói AUR được cập nhật:"
...
removeMakeDepsAfter_1 = \case
    ...
    Vietnamese -> "Loại bỏ các gói phụ thuộc không còn cần thiết sau khi make..."
...
cleanStates_2 n@(bt . tshow -> s) = \case
    ...
    Vietnamese -> s <> " lịch sử gói sẽ được lưu lại. Loại bỏ phần còn lại?"
...
cleanStates_3 = \case
    ...
    Vietnamese -> "Không có lịch sử gói nào được lưu."
...
cleanStates_4 n = \case
  ...
  Vietnamese -> "Bạn hiện đã lưu " <+> pretty n <+> " lịch sử gói."
...
backupCache_6 = \case
    ...
    Vietnamese -> "Tiếp tục với sao lưu?"
...
backupCache_7 = \case
    ...
    Vietnamese -> "Quá trình sao lưu bị hủy."
...
cleanCache_7 (bt . tshow -> ps) (bt . tshow -> bytes) = \case
    ...
    Vietnamese -> "Trong cache có chứa " <> ps <> " gói, chiếm " <> bytes <> " megabytes."
...
dependencyLookup_1 t = \case
  ...
  Vietnamese -> vsep ["Có lỗi trong quá trình tìm kiếm đệ quy gói phụ thuộc:", pretty t]
...
miscAURFailure_1 = \case
  ...
  Vietnamese -> "Kết nối tới AUR thất bại không rõ lý do."
...
restoreState_2 = \case
    ...
    Vietnamese -> "Không có lịch sử nào để khôi phục. (Dùng -B để lưu lịch sử hiện tại)"
...
whoIsBuildUser_1 = \case
    ...
    Vietnamese -> "Không thể xác định tài khoản người dùng để build."
...
security_1 (PkgName p) = \case
  ...
  Vietnamese -> "PKGBUILD của" <+> bt p <+> "quá phức tạp - nó có thể chứa đoạn mã nguy hiểm."
...
security_4 (bt -> t) = \case
  ...
  Vietnamese -> t <+> "được xác định là có người đang cố giành quyền root trên thiết bị của bạn."
...
security_7 = \case
  ...
  Vietnamese -> "Hãy dừng những quá trình tiếp theo để ngăn đoạn mã bash nguy hiểm."
...
security_12 = \case
  ...
  Vietnamese -> "Phát hiện các mối nguy hiểm trong PKGBUILD."
...
security_13 (bt -> w) = \case
  ...
  Vietnamese -> "Kiểm tra" <+> w <+> "tệp PKGBUILD để tím kiếm các mối nguy hiểm..."
...
security_14 = \case
  ...
  Vietnamese -> "Không tìm thấy mối nguy hiểm."
